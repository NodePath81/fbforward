...
- a single dashboard showing the current coordinated pick, node count, and
  connected-node detail
...
[fbcoord protocol reference](fbcoord-protocol.md#533-selection-algorithm).
