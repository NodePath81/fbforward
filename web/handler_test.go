...
func TestClientSecurityInvariants(t *testing.T) {
	...
	for _, required := range []string{"requestJSON('/identity')", "state.flows", "renderFlowTable()", "page: 'audit'", "history.replaceState", "refreshPending", "requestPage", "GetRouteStatus", "SetRouteOverride", "ClearRouteOverride"} {
